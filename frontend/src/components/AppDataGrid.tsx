import {
  ...
  const StyledGridOverlay = styled("div")(({ theme }) => ({
    ...
    "& .ant-empty-img-5": {
      fillOpacity: theme.palette.mode === "light" ? "0.5" : "0.08",
  ...
  const StripedDataGrid = styled(DataGrid)(({ theme }) => ({
    ...
    "&:first-of-type .MuiDataGrid-main>*": {
    ...
    "& .MuiTablePagination-root, .MuiTablePagination-root .MuiSelect-icon": {
      color: "inherit",
    },
  }));
  ...
  function AppDataGrid({
    ...
    return (
      <Box
        sx={{
          bgcolor: theme.palette.mode == 'dark'?"rgb(56,56,56)":'white',
          color:'white',
          [`& .${headerClassName}`]: {
            backgroundColor: theme.palette.mode == 'dark'?'rgb(45,45,45)':'rgb(15,21,128)',
